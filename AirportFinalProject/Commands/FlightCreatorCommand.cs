...
{
    class FlightCreatorCommand : CommandBase
    {
        private readonly IFlightCreator _flightCreator;
        private readonly CreateFlightViewModel _createViewModel;
        private readonly NavigationService _navigationService;
        public FlightCreatorCommand(IFlightCreator flightCreator, CreateFlightViewModel createFlightViewModel, NavigationService navigationService)
        {
